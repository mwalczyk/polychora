...
namespace four
{
    ...
    std::vector<std::vector<combinatorics::PermutationSeed<float>>> get_all_permutation_seeds()
    {
        ...
        return {
            ...
            {
                // All
                four::combinatorics::PermutationSeed<float>{ {0, 0, 4 * phi_1, 2 * phi_4}, true, four::combinatorics::Parity::ALL },
                four::combinatorics::PermutationSeed<float>{ {2 + phi_1, 2 + phi_1, 2 + 5 * phi_1, 2 + 5 * phi_1}, true, four::combinatorics::Parity::ALL },

                // Even
                four::combinatorics::PermutationSeed<float>{ {0, 1, 4 + 5 * phi_1, 1 + 5 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {0, 1, 3 * phi_1, 3 + 7 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {0, phi_1, 5 * phi_2, 1 + 4 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {0, 3 * phi_2, 3 + 4 * phi_1, 4 + 3 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {1, 2 * phi_1, 3 + 7 * phi_1, 2 + phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {1, 2 * phi_1, 5 * phi_2, phi_4}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {1, 2, phi_5, 2 + 5 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {1, 2 * phi_2, phi_5, 4 + 3 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {phi_1, 2, phi_3, 3 + 7 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {phi_1, phi_4, 2 + 5 * phi_1, 4 + 3 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2 * phi_1, 1 + 4 * phi_1, 2 + 5 * phi_1, 3 * phi_2}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2 * phi_1, phi_4, 1 + 5 * phi_1, 3 + 4 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2, 2 * phi_1, 2 * phi_4, 2 * phi_2}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2, phi_3, 4 + 5 * phi_1, 3 * phi_2}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2, 2 + phi_1, phi_5, 3 + 4 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {phi_3, 4 * phi_1, phi_5, phi_4}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {phi_3, 2 * phi_2, 1 + 5 * phi_1, 2 + 5 * phi_1}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {3 * phi_1, 2 * phi_2, 1 + 4 * phi_1, phi_5}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2 + phi_1, phi_3, 5 * phi_2, 2 * phi_2}, true, four::combinatorics::Parity::EVEN },
                four::combinatorics::PermutationSeed<float>{ {2 + phi_1, 3 * phi_1, 4 + 5 * phi_1, phi_4}, true, four::combinatorics::Parity::EVEN }
            },
    ...
    Polychoron get_dual(Polychoron polychoron)
    {
        switch (polychoron)
        {
    ...
    Definition get_definition(Polychoron polychoron)
    {
        switch (polychoron)
        {
        ...
        case Polychoron::Cell24Rectified:
            return {
                4,
                2,
                3,
    ...
    /// why, yet.
    std::vector<glm::vec4> get_vertices(Polychoron polychoron)
    {
        const float FRAC_1_SQRT_2 = 1.0f / sqrtf(2.0f);
        ...
        case Polychoron::Cell24Rectified:
            return {
                glm::vec4(FRAC_1_SQRT_2, FRAC_1_SQRT_2, 0.0, 0.0),
                glm::vec4(-FRAC_1_SQRT_2, FRAC_1_SQRT_2, 0.0, 0.0),
                glm::vec4(FRAC_1_SQRT_2, -FRAC_1_SQRT_2, 0.0, 0.0),
                glm::vec4(-FRAC_1_SQRT_2, -FRAC_1_SQRT_2, 0.0, 0.0),
                glm::vec4(0.0, FRAC_1_SQRT_2, FRAC_1_SQRT_2, 0.0),
                glm::vec4(0.0, -FRAC_1_SQRT_2, FRAC_1_SQRT_2, 0.0),
                glm::vec4(0.0, FRAC_1_SQRT_2, -FRAC_1_SQRT_2, 0.0),
                glm::vec4(0.0, -FRAC_1_SQRT_2, -FRAC_1_SQRT_2, 0.0),
                glm::vec4(0.0, 0.0, FRAC_1_SQRT_2, FRAC_1_SQRT_2),
                glm::vec4(0.0, 0.0, -FRAC_1_SQRT_2, FRAC_1_SQRT_2),
                glm::vec4(0.0, 0.0, FRAC_1_SQRT_2, -FRAC_1_SQRT_2),
                glm::vec4(0.0, 0.0, -FRAC_1_SQRT_2, -FRAC_1_SQRT_2),
                glm::vec4(0.0, FRAC_1_SQRT_2, 0.0, FRAC_1_SQRT_2),
                glm::vec4(0.0, -FRAC_1_SQRT_2, 0.0, FRAC_1_SQRT_2),
                glm::vec4(0.0, FRAC_1_SQRT_2, 0.0, -FRAC_1_SQRT_2),
                glm::vec4(0.0, -FRAC_1_SQRT_2, 0.0, -FRAC_1_SQRT_2),
                glm::vec4(FRAC_1_SQRT_2, 0.0, FRAC_1_SQRT_2, 0.0),
                glm::vec4(-FRAC_1_SQRT_2, 0.0, FRAC_1_SQRT_2, 0.0),
                glm::vec4(FRAC_1_SQRT_2, 0.0, -FRAC_1_SQRT_2, 0.0),
                glm::vec4(-FRAC_1_SQRT_2, 0.0, -FRAC_1_SQRT_2, 0.0),
                glm::vec4(FRAC_1_SQRT_2, 0.0, 0.0, FRAC_1_SQRT_2),
                glm::vec4(-FRAC_1_SQRT_2, 0.0, 0.0, FRAC_1_SQRT_2),
                glm::vec4(FRAC_1_SQRT_2, 0.0, 0.0, -FRAC_1_SQRT_2),
                glm::vec4(-FRAC_1_SQRT_2, 0.0, 0.0, -FRAC_1_SQRT_2),
            };
        case Polychoron::Cell120:
            return {
                ...
                glm::vec4(-FRAC_1_SQRT_2, 0.0, FRAC_1_SQRT_2, 0.0),
                glm::vec4(-FRAC_1_SQRT_2, 0.0, -FRAC_1_SQRT_2, 0.0),
                glm::vec4(0.790569, 0.353553, 0.353553, 0.353553),
                glm::vec4(0.790569, 0.353553, 0.353553, -0.353553),
                glm::vec4(0.790569, 0.353553, -0.353553, 0.353553),
                glm::vec4(0.790569, 0.353553, -0.353553, -0.353553),
                glm::vec4(0.790569, -0.353553, 0.353553, 0.353553),
                ...
                glm::vec4(-0.790569, -0.353553, -0.353553, 0.353553),
                glm::vec4(-0.790569, -0.353553, -0.353553, -0.353553),
                glm::vec4(0.353553, 0.353553, 0.353553, 0.790569),
                glm::vec4(0.353553, 0.353553, 0.353553, -0.790569),
                glm::vec4(0.353553, 0.353553, -0.353553, 0.790569),
                glm::vec4(0.353553, 0.353553, -0.353553, -0.790569),
                glm::vec4(0.353553, -0.353553, 0.353553, 0.790569),
                ...
                glm::vec4(-0.353553, -0.353553, -0.353553, 0.790569),
                glm::vec4(-0.353553, -0.353553, -0.353553, -0.790569),
                glm::vec4(0.353553, 0.353553, 0.790569, 0.353553),
                glm::vec4(0.353553, 0.353553, 0.790569, -0.353553),
                glm::vec4(0.353553, 0.353553, -0.790569, 0.353553),
                glm::vec4(0.353553, 0.353553, -0.790569, -0.353553),
                glm::vec4(0.353553, -0.353553, 0.790569, 0.353553),
                ...
                glm::vec4(-0.353553, -0.353553, -0.790569, 0.353553),
                glm::vec4(-0.353553, -0.353553, -0.790569, -0.353553),
                glm::vec4(0.353553, 0.790569, 0.353553, 0.353553),
                glm::vec4(0.353553, 0.790569, 0.353553, -0.353553),
                glm::vec4(0.353553, 0.790569, -0.353553, 0.353553),
                glm::vec4(0.353553, 0.790569, -0.353553, -0.353553),
                glm::vec4(0.353553, -0.790569, 0.353553, 0.353553),
                ...
                glm::vec4(-0.353553, -0.790569, -0.353553, 0.353553),
                glm::vec4(-0.353553, -0.790569, -0.353553, -0.353553),
                glm::vec4(0.572061, 0.572061, 0.572061, 0.135045),
                glm::vec4(0.572061, 0.572061, 0.572061, -0.135045),
                glm::vec4(0.572061, 0.572061, -0.572061, 0.135045),
                glm::vec4(0.572061, 0.572061, -0.572061, -0.135045),
                glm::vec4(0.572061, -0.572061, 0.572061, 0.135045),
                ...
                glm::vec4(-0.572061, -0.572061, -0.572061, 0.135045),
                glm::vec4(-0.572061, -0.572061, -0.572061, -0.135045),
                glm::vec4(0.135045, 0.572061, 0.572061, 0.572061),
                glm::vec4(0.135045, 0.572061, 0.572061, -0.572061),
                glm::vec4(0.135045, 0.572061, -0.572061, 0.572061),
                glm::vec4(0.135045, 0.572061, -0.572061, -0.572061),
                glm::vec4(0.135045, -0.572061, 0.572061, 0.572061),
                ...
                glm::vec4(-0.135045, -0.572061, -0.572061, 0.572061),
                glm::vec4(-0.135045, -0.572061, -0.572061, -0.572061),
                glm::vec4(0.572061, 0.135045, 0.572061, 0.572061),
                glm::vec4(0.572061, 0.135045, 0.572061, -0.572061),
                glm::vec4(0.572061, 0.135045, -0.572061, 0.572061),
                glm::vec4(0.572061, 0.135045, -0.572061, -0.572061),
                glm::vec4(0.572061, -0.135045, 0.572061, 0.572061),
                ...
                glm::vec4(-0.572061, -0.135045, -0.572061, 0.572061),
                glm::vec4(-0.572061, -0.135045, -0.572061, -0.572061),
                glm::vec4(0.572061, 0.572061, 0.135045, 0.572061),
                glm::vec4(0.572061, 0.572061, 0.135045, -0.572061),
                glm::vec4(0.572061, 0.572061, -0.135045, 0.572061),
                glm::vec4(0.572061, 0.572061, -0.135045, -0.572061),
                glm::vec4(0.572061, -0.572061, 0.135045, 0.572061),
                ...
                glm::vec4(-0.572061, -0.572061, -0.135045, 0.572061),
                glm::vec4(-0.572061, -0.572061, -0.135045, -0.572061),
                glm::vec4(0.925615, 0.218508, 0.218508, 0.218508),
                glm::vec4(0.925615, 0.218508, 0.218508, -0.218508),
                glm::vec4(0.925615, 0.218508, -0.218508, 0.218508),
                glm::vec4(0.925615, 0.218508, -0.218508, -0.218508),
                glm::vec4(0.925615, -0.218508, 0.218508, 0.218508),
                ...
                glm::vec4(-0.925615, -0.218508, -0.218508, 0.218508),
                glm::vec4(-0.925615, -0.218508, -0.218508, -0.218508),
                glm::vec4(0.218508, 0.218508, 0.218508, 0.925615),
                glm::vec4(0.218508, 0.218508, 0.218508, -0.925615),
                glm::vec4(0.218508, 0.218508, -0.218508, 0.925615),
                glm::vec4(0.218508, 0.218508, -0.218508, -0.925615),
                glm::vec4(0.218508, -0.218508, 0.218508, 0.925615),
                ...
                glm::vec4(-0.218508, -0.218508, -0.218508, 0.925615),
                glm::vec4(-0.218508, -0.218508, -0.218508, -0.925615),
                glm::vec4(0.218508, 0.218508, 0.925615, 0.218508),
                glm::vec4(0.218508, 0.218508, 0.925615, -0.218508),
                glm::vec4(0.218508, 0.218508, -0.925615, 0.218508),
                glm::vec4(0.218508, 0.218508, -0.925615, -0.218508),
                glm::vec4(0.218508, -0.218508, 0.925615, 0.218508),
                ...
                glm::vec4(-0.218508, -0.218508, -0.925615, 0.218508),
                glm::vec4(-0.218508, -0.218508, -0.925615, -0.218508),
                glm::vec4(0.218508, 0.925615, 0.218508, 0.218508),
                glm::vec4(0.218508, 0.925615, 0.218508, -0.218508),
                glm::vec4(0.218508, 0.925615, -0.218508, 0.218508),
                glm::vec4(0.218508, 0.925615, -0.218508, -0.218508),
                glm::vec4(0.218508, -0.925615, 0.218508, 0.218508),
                ...
                glm::vec4(-0.218508, -0.925615, -0.218508, 0.218508),
                glm::vec4(-0.218508, -0.925615, -0.218508, -0.218508),
                glm::vec4(0.925615, 0.135045, 0.353553, 0.0),
                glm::vec4(0.925615, 0.135045, -0.353553, 0.0),
                glm::vec4(0.925615, -0.135045, 0.353553, 0.0),
                glm::vec4(0.925615, -0.135045, -0.353553, 0.0),
                glm::vec4(-0.925615, 0.135045, 0.353553, 0.0),
                ...
                glm::vec4(-0.925615, -0.135045, 0.353553, 0.0),
                glm::vec4(-0.925615, -0.135045, -0.353553, 0.0),
                glm::vec4(0.925615, 0.353553, 0.0, 0.135045),
                glm::vec4(0.925615, 0.353553, 0.0, -0.135045),
                glm::vec4(0.925615, -0.353553, 0.0, 0.135045),
                glm::vec4(0.925615, -0.353553, 0.0, -0.135045),
                glm::vec4(-0.925615, 0.353553, 0.0, 0.135045),
                ...
                glm::vec4(-0.925615, -0.353553, 0.0, 0.135045),
                glm::vec4(-0.925615, -0.353553, 0.0, -0.135045),
                glm::vec4(0.0, 0.135045, 0.925615, 0.353553),
                glm::vec4(0.0, 0.135045, 0.925615, -0.353553),
                glm::vec4(0.0, 0.135045, -0.925615, 0.353553),
                glm::vec4(0.0, 0.135045, -0.925615, -0.353553),
                glm::vec4(0.0, -0.135045, 0.925615, 0.353553),
                ...
                glm::vec4(0.0, -0.135045, -0.925615, 0.353553),
                glm::vec4(0.0, -0.135045, -0.925615, -0.353553),
                glm::vec4(0.0, 0.353553, 0.135045, 0.925615),
                glm::vec4(0.0, 0.353553, 0.135045, -0.925615),
                glm::vec4(0.0, 0.353553, -0.135045, 0.925615),
                glm::vec4(0.0, 0.353553, -0.135045, -0.925615),
                glm::vec4(0.0, -0.353553, 0.135045, 0.925615),
                ...
                glm::vec4(0.0, -0.353553, -0.135045, 0.925615),
                glm::vec4(0.0, -0.353553, -0.135045, -0.925615),
                glm::vec4(0.0, 0.925615, 0.353553, 0.135045),
                glm::vec4(0.0, 0.925615, 0.353553, -0.135045),
                glm::vec4(0.0, 0.925615, -0.353553, 0.135045),
                glm::vec4(0.0, 0.925615, -0.353553, -0.135045),
                glm::vec4(0.0, -0.925615, 0.353553, 0.135045),
                ...
                glm::vec4(0.0, -0.925615, -0.353553, 0.135045),
                glm::vec4(0.0, -0.925615, -0.353553, -0.135045),
                glm::vec4(0.135045, 0.0, 0.353553, 0.925615),
                glm::vec4(0.135045, 0.0, 0.353553, -0.925615),
                glm::vec4(0.135045, 0.0, -0.353553, 0.925615),
                glm::vec4(0.135045, 0.0, -0.353553, -0.925615),
                glm::vec4(-0.135045, 0.0, 0.353553, 0.925615),
                ...
                glm::vec4(-0.135045, 0.0, -0.353553, 0.925615),
                glm::vec4(-0.135045, 0.0, -0.353553, -0.925615),
                glm::vec4(0.135045, 0.353553, 0.925615, 0.0),
                glm::vec4(0.135045, 0.353553, -0.925615, 0.0),
                glm::vec4(0.135045, -0.353553, 0.925615, 0.0),
                glm::vec4(0.135045, -0.353553, -0.925615, 0.0),
                glm::vec4(-0.135045, 0.353553, 0.925615, 0.0),
                ...
                glm::vec4(-0.135045, -0.353553, 0.925615, 0.0),
                glm::vec4(-0.135045, -0.353553, -0.925615, 0.0),
                glm::vec4(0.135045, 0.925615, 0.0, 0.353553),
                glm::vec4(0.135045, 0.925615, 0.0, -0.353553),
                glm::vec4(0.135045, -0.925615, 0.0, 0.353553),
                glm::vec4(0.135045, -0.925615, 0.0, -0.353553),
                glm::vec4(-0.135045, 0.925615, 0.0, 0.353553),
                ...
                glm::vec4(-0.135045, -0.925615, 0.0, 0.353553),
                glm::vec4(-0.135045, -0.925615, 0.0, -0.353553),
                glm::vec4(0.353553, 0.0, 0.925615, 0.135045),
                glm::vec4(0.353553, 0.0, 0.925615, -0.135045),
                glm::vec4(0.353553, 0.0, -0.925615, 0.135045),
                glm::vec4(0.353553, 0.0, -0.925615, -0.135045),
                glm::vec4(-0.353553, 0.0, 0.925615, 0.135045),
                ...
                glm::vec4(-0.353553, 0.0, -0.925615, 0.135045),
                glm::vec4(-0.353553, 0.0, -0.925615, -0.135045),
                glm::vec4(0.353553, 0.135045, 0.0, 0.925615),
                glm::vec4(0.353553, 0.135045, 0.0, -0.925615),
                glm::vec4(0.353553, -0.135045, 0.0, 0.925615),
                glm::vec4(0.353553, -0.135045, 0.0, -0.925615),
                glm::vec4(-0.353553, 0.135045, 0.0, 0.925615),
                ...
                glm::vec4(-0.353553, -0.135045, 0.0, 0.925615),
                glm::vec4(-0.353553, -0.135045, 0.0, -0.925615),
                glm::vec4(0.353553, 0.925615, 0.135045, 0.0),
                glm::vec4(0.353553, 0.925615, -0.135045, 0.0),
                glm::vec4(0.353553, -0.925615, 0.135045, 0.0),
                glm::vec4(0.353553, -0.925615, -0.135045, 0.0),
                glm::vec4(-0.353553, 0.925615, 0.135045, 0.0),
                ...
                glm::vec4(-0.353553, -0.925615, 0.135045, 0.0),
                glm::vec4(-0.353553, -0.925615, -0.135045, 0.0),
                glm::vec4(0.925615, 0.0, 0.135045, 0.353553),
                glm::vec4(0.925615, 0.0, 0.135045, -0.353553),
                glm::vec4(0.925615, 0.0, -0.135045, 0.353553),
                glm::vec4(0.925615, 0.0, -0.135045, -0.353553),
                glm::vec4(-0.925615, 0.0, 0.135045, 0.353553),
                ...
                glm::vec4(-0.925615, 0.0, -0.135045, 0.353553),
                glm::vec4(-0.925615, 0.0, -0.135045, -0.353553),
                glm::vec4(0.790569, 0.218508, 0.572061, 0.0),
                glm::vec4(0.790569, 0.218508, -0.572061, 0.0),
                glm::vec4(0.790569, -0.218508, 0.572061, 0.0),
                glm::vec4(0.790569, -0.218508, -0.572061, 0.0),
                glm::vec4(-0.790569, 0.218508, 0.572061, 0.0),
                ...
                glm::vec4(-0.790569, -0.218508, 0.572061, 0.0),
                glm::vec4(-0.790569, -0.218508, -0.572061, 0.0),
                glm::vec4(0.790569, 0.572061, 0.0, 0.218508),
                glm::vec4(0.790569, 0.572061, 0.0, -0.218508),
                glm::vec4(0.790569, -0.572061, 0.0, 0.218508),
                glm::vec4(0.790569, -0.572061, 0.0, -0.218508),
                glm::vec4(-0.790569, 0.572061, 0.0, 0.218508),
                ...
                glm::vec4(-0.790569, -0.572061, 0.0, 0.218508),
                glm::vec4(-0.790569, -0.572061, 0.0, -0.218508),
                glm::vec4(0.0, 0.218508, 0.790569, 0.572061),
                glm::vec4(0.0, 0.218508, 0.790569, -0.572061),
                glm::vec4(0.0, 0.218508, -0.790569, 0.572061),
                glm::vec4(0.0, 0.218508, -0.790569, -0.572061),
                glm::vec4(0.0, -0.218508, 0.790569, 0.572061),
                ...
                glm::vec4(0.0, -0.218508, -0.790569, 0.572061),
                glm::vec4(0.0, -0.218508, -0.790569, -0.572061),
                glm::vec4(0.0, 0.572061, 0.218508, 0.790569),
                glm::vec4(0.0, 0.572061, 0.218508, -0.790569),
                glm::vec4(0.0, 0.572061, -0.218508, 0.790569),
                glm::vec4(0.0, 0.572061, -0.218508, -0.790569),
                glm::vec4(0.0, -0.572061, 0.218508, 0.790569),
                ...
                glm::vec4(0.0, -0.572061, -0.218508, 0.790569),
                glm::vec4(0.0, -0.572061, -0.218508, -0.790569),
                glm::vec4(0.0, 0.790569, 0.572061, 0.218508),
                glm::vec4(0.0, 0.790569, 0.572061, -0.218508),
                glm::vec4(0.0, 0.790569, -0.572061, 0.218508),
                glm::vec4(0.0, 0.790569, -0.572061, -0.218508),
                glm::vec4(0.0, -0.790569, 0.572061, 0.218508),
                ...
                glm::vec4(0.0, -0.790569, -0.572061, 0.218508),
                glm::vec4(0.0, -0.790569, -0.572061, -0.218508),
                glm::vec4(0.218508, 0.0, 0.572061, 0.790569),
                glm::vec4(0.218508, 0.0, 0.572061, -0.790569),
                glm::vec4(0.218508, 0.0, -0.572061, 0.790569),
                glm::vec4(0.218508, 0.0, -0.572061, -0.790569),
                glm::vec4(-0.218508, 0.0, 0.572061, 0.790569),
                ...
                glm::vec4(-0.218508, 0.0, -0.572061, 0.790569),
                glm::vec4(-0.218508, 0.0, -0.572061, -0.790569),
                glm::vec4(0.218508, 0.572061, 0.790569, 0.0),
                glm::vec4(0.218508, 0.572061, -0.790569, 0.0),
                glm::vec4(0.218508, -0.572061, 0.790569, 0.0),
                glm::vec4(0.218508, -0.572061, -0.790569, 0.0),
                glm::vec4(-0.218508, 0.572061, 0.790569, 0.0),
                ...
                glm::vec4(-0.218508, -0.572061, 0.790569, 0.0),
                glm::vec4(-0.218508, -0.572061, -0.790569, 0.0),
                glm::vec4(0.218508, 0.790569, 0.0, 0.572061),
                glm::vec4(0.218508, 0.790569, 0.0, -0.572061),
                glm::vec4(0.218508, -0.790569, 0.0, 0.572061),
                glm::vec4(0.218508, -0.790569, 0.0, -0.572061),
                glm::vec4(-0.218508, 0.790569, 0.0, 0.572061),
                ...
                glm::vec4(-0.218508, -0.790569, 0.0, 0.572061),
                glm::vec4(-0.218508, -0.790569, 0.0, -0.572061),
                glm::vec4(0.572061, 0.0, 0.790569, 0.218508),
                glm::vec4(0.572061, 0.0, 0.790569, -0.218508),
                glm::vec4(0.572061, 0.0, -0.790569, 0.218508),
                glm::vec4(0.572061, 0.0, -0.790569, -0.218508),
                glm::vec4(-0.572061, 0.0, 0.790569, 0.218508),
                ...
                glm::vec4(-0.572061, 0.0, -0.790569, 0.218508),
                glm::vec4(-0.572061, 0.0, -0.790569, -0.218508),
                glm::vec4(0.572061, 0.218508, 0.0, 0.790569),
                glm::vec4(0.572061, 0.218508, 0.0, -0.790569),
                glm::vec4(0.572061, -0.218508, 0.0, 0.790569),
                glm::vec4(0.572061, -0.218508, 0.0, -0.790569),
                glm::vec4(-0.572061, 0.218508, 0.0, 0.790569),
                ...
                glm::vec4(-0.572061, -0.218508, 0.0, 0.790569),
                glm::vec4(-0.572061, -0.218508, 0.0, -0.790569),
                glm::vec4(0.572061, 0.790569, 0.218508, 0.0),
                glm::vec4(0.572061, 0.790569, -0.218508, 0.0),
                glm::vec4(0.572061, -0.790569, 0.218508, 0.0),
                glm::vec4(0.572061, -0.790569, -0.218508, 0.0),
                glm::vec4(-0.572061, 0.790569, 0.218508, 0.0),
                ...
                glm::vec4(-0.572061, -0.790569, 0.218508, 0.0),
                glm::vec4(-0.572061, -0.790569, -0.218508, 0.0),
                glm::vec4(0.790569, 0.0, 0.218508, 0.572061),
                glm::vec4(0.790569, 0.0, 0.218508, -0.572061),
                glm::vec4(0.790569, 0.0, -0.218508, 0.572061),
                glm::vec4(0.790569, 0.0, -0.218508, -0.572061),
                glm::vec4(-0.790569, 0.0, 0.218508, 0.572061),
                ...
                glm::vec4(-0.790569, 0.0, -0.218508, 0.572061),
                glm::vec4(-0.790569, 0.0, -0.218508, -0.572061),
                glm::vec4(FRAC_1_SQRT_2, 0.353553, 0.572061, 0.218508),
                glm::vec4(FRAC_1_SQRT_2, 0.353553, 0.572061, -0.218508),
                glm::vec4(FRAC_1_SQRT_2, 0.353553, -0.572061, 0.218508),
                glm::vec4(FRAC_1_SQRT_2, 0.353553, -0.572061, -0.218508),
                glm::vec4(FRAC_1_SQRT_2, -0.353553, 0.572061, 0.218508),
                ...
                glm::vec4(-FRAC_1_SQRT_2, -0.353553, -0.572061, 0.218508),
                glm::vec4(-FRAC_1_SQRT_2, -0.353553, -0.572061, -0.218508),
                glm::vec4(FRAC_1_SQRT_2, 0.572061, 0.218508, 0.353553),
                glm::vec4(FRAC_1_SQRT_2, 0.572061, 0.218508, -0.353553),
                glm::vec4(FRAC_1_SQRT_2, 0.572061, -0.218508, 0.353553),
                glm::vec4(FRAC_1_SQRT_2, 0.572061, -0.218508, -0.353553),
                glm::vec4(FRAC_1_SQRT_2, -0.572061, 0.218508, 0.353553),
                ...
                glm::vec4(-FRAC_1_SQRT_2, -0.572061, -0.218508, 0.353553),
                glm::vec4(-FRAC_1_SQRT_2, -0.572061, -0.218508, -0.353553),
                glm::vec4(0.218508, 0.353553, FRAC_1_SQRT_2, 0.572061),
                glm::vec4(0.218508, 0.353553, FRAC_1_SQRT_2, -0.572061),
                glm::vec4(0.218508, 0.353553, -FRAC_1_SQRT_2, 0.572061),
                glm::vec4(0.218508, 0.353553, -FRAC_1_SQRT_2, -0.572061),
                glm::vec4(0.218508, -0.353553, FRAC_1_SQRT_2, 0.572061),
                ...
                glm::vec4(-0.218508, -0.353553, -FRAC_1_SQRT_2, 0.572061),
                glm::vec4(-0.218508, -0.353553, -FRAC_1_SQRT_2, -0.572061),
                glm::vec4(0.218508, 0.572061, 0.353553, FRAC_1_SQRT_2),
                glm::vec4(0.218508, 0.572061, 0.353553, -FRAC_1_SQRT_2),
                glm::vec4(0.218508, 0.572061, -0.353553, FRAC_1_SQRT_2),
                glm::vec4(0.218508, 0.572061, -0.353553, -FRAC_1_SQRT_2),
                glm::vec4(0.218508, -0.572061, 0.353553, FRAC_1_SQRT_2),
                ...
                glm::vec4(-0.218508, -0.572061, -0.353553, FRAC_1_SQRT_2),
                glm::vec4(-0.218508, -0.572061, -0.353553, -FRAC_1_SQRT_2),
                glm::vec4(0.218508, FRAC_1_SQRT_2, 0.572061, 0.353553),
                glm::vec4(0.218508, FRAC_1_SQRT_2, 0.572061, -0.353553),
                glm::vec4(0.218508, FRAC_1_SQRT_2, -0.572061, 0.353553),
                glm::vec4(0.218508, FRAC_1_SQRT_2, -0.572061, -0.353553),
                glm::vec4(0.218508, -FRAC_1_SQRT_2, 0.572061, 0.353553),
                ...
                glm::vec4(-0.218508, -FRAC_1_SQRT_2, -0.572061, 0.353553),
                glm::vec4(-0.218508, -FRAC_1_SQRT_2, -0.572061, -0.353553),
                glm::vec4(0.353553, 0.218508, 0.572061, FRAC_1_SQRT_2),
                glm::vec4(0.353553, 0.218508, 0.572061, -FRAC_1_SQRT_2),
                glm::vec4(0.353553, 0.218508, -0.572061, FRAC_1_SQRT_2),
                glm::vec4(0.353553, 0.218508, -0.572061, -FRAC_1_SQRT_2),
                glm::vec4(0.353553, -0.218508, 0.572061, FRAC_1_SQRT_2),
                ...
                glm::vec4(-0.353553, -0.218508, -0.572061, FRAC_1_SQRT_2),
                glm::vec4(-0.353553, -0.218508, -0.572061, -FRAC_1_SQRT_2),
                glm::vec4(0.353553, 0.572061, FRAC_1_SQRT_2, 0.218508),
                glm::vec4(0.353553, 0.572061, FRAC_1_SQRT_2, -0.218508),
                glm::vec4(0.353553, 0.572061, -FRAC_1_SQRT_2, 0.218508),
                glm::vec4(0.353553, 0.572061, -FRAC_1_SQRT_2, -0.218508),
                glm::vec4(0.353553, -0.572061, FRAC_1_SQRT_2, 0.218508),
                ...
                glm::vec4(-0.353553, -0.572061, -FRAC_1_SQRT_2, 0.218508),
                glm::vec4(-0.353553, -0.572061, -FRAC_1_SQRT_2, -0.218508),
                glm::vec4(0.353553, FRAC_1_SQRT_2, 0.218508, 0.572061),
                glm::vec4(0.353553, FRAC_1_SQRT_2, 0.218508, -0.572061),
                glm::vec4(0.353553, FRAC_1_SQRT_2, -0.218508, 0.572061),
                glm::vec4(0.353553, FRAC_1_SQRT_2, -0.218508, -0.572061),
                glm::vec4(0.353553, -FRAC_1_SQRT_2, 0.218508, 0.572061),
                ...
                glm::vec4(-0.353553, -FRAC_1_SQRT_2, -0.218508, 0.572061),
                glm::vec4(-0.353553, -FRAC_1_SQRT_2, -0.218508, -0.572061),
                glm::vec4(0.572061, 0.218508, FRAC_1_SQRT_2, 0.353553),
                glm::vec4(0.572061, 0.218508, FRAC_1_SQRT_2, -0.353553),
                glm::vec4(0.572061, 0.218508, -FRAC_1_SQRT_2, 0.353553),
                glm::vec4(0.572061, 0.218508, -FRAC_1_SQRT_2, -0.353553),
                glm::vec4(0.572061, -0.218508, FRAC_1_SQRT_2, 0.353553),
                ...
                glm::vec4(-0.572061, -0.218508, -FRAC_1_SQRT_2, 0.353553),
                glm::vec4(-0.572061, -0.218508, -FRAC_1_SQRT_2, -0.353553),
                glm::vec4(0.572061, 0.353553, 0.218508, FRAC_1_SQRT_2),
                glm::vec4(0.572061, 0.353553, 0.218508, -FRAC_1_SQRT_2),
                glm::vec4(0.572061, 0.353553, -0.218508, FRAC_1_SQRT_2),
                glm::vec4(0.572061, 0.353553, -0.218508, -FRAC_1_SQRT_2),
                glm::vec4(0.572061, -0.353553, 0.218508, FRAC_1_SQRT_2),
                ...
                glm::vec4(-0.572061, -0.353553, -0.218508, FRAC_1_SQRT_2),
                glm::vec4(-0.572061, -0.353553, -0.218508, -FRAC_1_SQRT_2),
                glm::vec4(0.572061, FRAC_1_SQRT_2, 0.353553, 0.218508),
                glm::vec4(0.572061, FRAC_1_SQRT_2, 0.353553, -0.218508),
                glm::vec4(0.572061, FRAC_1_SQRT_2, -0.353553, 0.218508),
                glm::vec4(0.572061, FRAC_1_SQRT_2, -0.353553, -0.218508),
                glm::vec4(0.572061, -FRAC_1_SQRT_2, 0.353553, 0.218508),
                ...
                glm::vec4(-0.572061, -FRAC_1_SQRT_2, -0.353553, 0.218508),
                glm::vec4(-0.572061, -FRAC_1_SQRT_2, -0.353553, -0.218508),
                glm::vec4(FRAC_1_SQRT_2, 0.218508, 0.353553, 0.572061),
                glm::vec4(FRAC_1_SQRT_2, 0.218508, 0.353553, -0.572061),
                glm::vec4(FRAC_1_SQRT_2, 0.218508, -0.353553, 0.572061),
                glm::vec4(FRAC_1_SQRT_2, 0.218508, -0.353553, -0.572061),
                glm::vec4(FRAC_1_SQRT_2, -0.218508, 0.353553, 0.572061),
        ...
        case Polychoron::Cell600:
            return {
                ...
                glm::vec4(0.0, 0.0, 0.0, 1.0),
                glm::vec4(0.0, 0.0, 0.0, -1.0),
                glm::vec4(0.0, 0.309017, 0.5, 0.809015),
                glm::vec4(0.0, 0.309017, -0.5, 0.809015),
                glm::vec4(0.0, -0.309017, 0.5, 0.809015),
                glm::vec4(0.0, 0.309017, 0.5, -0.809015),
                glm::vec4(0.0, -0.309017, -0.5, 0.809015),
                ...
                glm::vec4(0.0, -0.309017, 0.5, -0.809015),
                glm::vec4(0.0, -0.309017, -0.5, -0.809015),
                glm::vec4(0.0, 0.809015, 0.309017, 0.5),
                glm::vec4(0.0, 0.809015, -0.309017, 0.5),
                glm::vec4(0.0, -0.809015, 0.309017, 0.5),
                glm::vec4(0.0, 0.809015, 0.309017, -0.5),
                glm::vec4(0.0, -0.809015, -0.309017, 0.5),
                ...
                glm::vec4(0.0, -0.809015, 0.309017, -0.5),
                glm::vec4(0.0, -0.809015, -0.309017, -0.5),
                glm::vec4(0.0, 0.5, 0.809015, 0.309017),
                glm::vec4(0.0, 0.5, -0.809015, 0.309017),
                glm::vec4(0.0, -0.5, 0.809015, 0.309017),
                glm::vec4(0.0, 0.5, 0.809015, -0.309017),
                glm::vec4(0.0, -0.5, -0.809015, 0.309017),
                ...
                glm::vec4(0.0, -0.5, 0.809015, -0.309017),
                glm::vec4(0.0, -0.5, -0.809015, -0.309017),
                glm::vec4(0.5, 0.809015, 0.0, 0.309017),
                glm::vec4(-0.5, 0.809015, 0.0, 0.309017),
                glm::vec4(0.5, -0.809015, 0.0, 0.309017),
                glm::vec4(0.5, 0.809015, 0.0, -0.309017),
                glm::vec4(-0.5, -0.809015, 0.0, 0.309017),
                ...
                glm::vec4(0.5, -0.809015, 0.0, -0.309017),
                glm::vec4(-0.5, -0.809015, 0.0, -0.309017),
                glm::vec4(0.309017, 0.5, 0.0, 0.809015),
                glm::vec4(-0.309017, 0.5, 0.0, 0.809015),
                glm::vec4(0.309017, -0.5, 0.0, 0.809015),
                glm::vec4(0.309017, 0.5, 0.0, -0.809015),
                glm::vec4(-0.309017, -0.5, 0.0, 0.809015),
                ...
                glm::vec4(0.309017, -0.5, 0.0, -0.809015),
                glm::vec4(-0.309017, -0.5, 0.0, -0.809015),
                glm::vec4(0.809015, 0.309017, 0.0, 0.5),
                glm::vec4(-0.809015, 0.309017, 0.0, 0.5),
                glm::vec4(0.809015, -0.309017, 0.0, 0.5),
                glm::vec4(0.809015, 0.309017, 0.0, -0.5),
                glm::vec4(-0.809015, -0.309017, 0.0, 0.5),
                ...
                glm::vec4(0.809015, -0.309017, 0.0, -0.5),
                glm::vec4(-0.809015, -0.309017, 0.0, -0.5),
                glm::vec4(0.309017, 0.0, 0.809015, 0.5),
                glm::vec4(-0.309017, 0.0, 0.809015, 0.5),
                glm::vec4(0.309017, 0.0, -0.809015, 0.5),
                glm::vec4(0.309017, 0.0, 0.809015, -0.5),
                glm::vec4(-0.309017, 0.0, -0.809015, 0.5),
                ...
                glm::vec4(0.309017, 0.0, -0.809015, -0.5),
                glm::vec4(-0.309017, 0.0, -0.809015, -0.5),
                glm::vec4(0.809015, 0.0, 0.5, 0.309017),
                glm::vec4(-0.809015, 0.0, 0.5, 0.309017),
                glm::vec4(0.809015, 0.0, -0.5, 0.309017),
                glm::vec4(0.809015, 0.0, 0.5, -0.309017),
                glm::vec4(-0.809015, 0.0, -0.5, 0.309017),
                ...
                glm::vec4(0.809015, 0.0, -0.5, -0.309017),
                glm::vec4(-0.809015, 0.0, -0.5, -0.309017),
                glm::vec4(0.5, 0.0, 0.309017, 0.809015),
                glm::vec4(-0.5, 0.0, 0.309017, 0.809015),
                glm::vec4(0.5, 0.0, -0.309017, 0.809015),
                glm::vec4(0.5, 0.0, 0.309017, -0.809015),
                glm::vec4(-0.5, 0.0, -0.309017, 0.809015),
                ...
                glm::vec4(0.5, 0.0, -0.309017, -0.809015),
                glm::vec4(-0.5, 0.0, -0.309017, -0.809015),
                glm::vec4(0.809015, 0.5, 0.309017, 0.0),
                glm::vec4(-0.809015, 0.5, 0.309017, 0.0),
                glm::vec4(0.809015, 0.5, -0.309017, 0.0),
                glm::vec4(0.809015, -0.5, 0.309017, 0.0),
                glm::vec4(-0.809015, 0.5, -0.309017, 0.0),
                ...
                glm::vec4(0.809015, -0.5, -0.309017, 0.0),
                glm::vec4(-0.809015, -0.5, -0.309017, 0.0),
                glm::vec4(0.5, 0.309017, 0.809015, 0.0),
                glm::vec4(-0.5, 0.309017, 0.809015, 0.0),
                glm::vec4(0.5, 0.309017, -0.809015, 0.0),
                glm::vec4(0.5, -0.309017, 0.809015, 0.0),
                glm::vec4(-0.5, 0.309017, -0.809015, 0.0),
                ...
                glm::vec4(0.5, -0.309017, -0.809015, 0.0),
                glm::vec4(-0.5, -0.309017, -0.809015, 0.0),
                glm::vec4(0.309017, 0.809015, 0.5, 0.0),
                glm::vec4(-0.309017, 0.809015, 0.5, 0.0),
                glm::vec4(0.309017, 0.809015, -0.5, 0.0),
                glm::vec4(0.309017, -0.809015, 0.5, 0.0),
                glm::vec4(-0.309017, 0.809015, -0.5, 0.0),
    ...
    std::vector<uint32_t> get_edges(Polychoron polychoron)
    {
        switch (polychoron)
        {
        case Polychoron::Cell8:
    ...
    std::vector<uint32_t> get_faces(Polychoron polychoron)
    {
        switch (polychoron)
        {
        case Polychoron::Cell8:
    ...
    std::vector<Hyperplane> get_h_representation(Polychoron polychoron)
    {
        ...
        case Polychoron::Cell16:
            ...
            break;
        case Polychoron::Cell24:
            displacement = 1.0f / sqrtf(2.0f);
            break;
        case Polychoron::Cell24Rectified:
            displacement = 1.0f / sqrtf(2.0f);
            break;
        case Polychoron::Cell120:
            displacement = -0.925615f;
            break;
        case Polychoron::Cell600:
            displacement = -0.925615f;
            break;
        ...
        {
            bounding_hyperplanes.push_back({ vertex, displacement });
        }
